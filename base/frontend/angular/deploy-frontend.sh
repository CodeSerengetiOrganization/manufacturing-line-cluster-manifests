...
echo "--- K3s Angular Frontend Deployment ---"

FULL_IMAGE_NAME="${REPO_URL}:${TARGET_TAG}"
echo "Deploying image: ${FULL_IMAGE_NAME}"

TEMP_MANIFEST="/tmp/angular-frontend-deployment.$$.yaml"
...
echo "Angular frontend deployed successfully!"
echo "Access Angular app via NodePort 30080: http://<node-ip>:30080"
